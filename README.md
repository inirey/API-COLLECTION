...
| Faza Api | Fadly ID | [Link](https://api.faza.xyz) | `Aktif` | API collection | `APIKEY` |
...
| AdiOfficial API | M imam Adi | [Link](https://adiofficial-api.herokuapp.com) | `Aktif` | API collection. | `APIKEY` |
...
| Sanuwa API | [Sanuwa](https://github.com/sanuwaofficial) | [Link](https://sanuwa-api.herokuapp.com/) | `Aktif` | API Collection | `APIKEY` |
